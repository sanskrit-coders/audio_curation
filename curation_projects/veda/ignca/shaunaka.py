...
def update_repos(gmusic_client, dry_run=False):
    ...
    repo = VedaRepoBase(repo_paths=[os.path.join("/home/vvasuki/Music/git-curation/veda-audio", "shaunaka-atharva-veda-ignca")], archive_audio_item=archive_audio_item, git_remote_origin_basepath=None, gmusic_client=gmusic_client)
