...
class Gopal2014Repo(audio_repo.AudioRepo):
...
def update_gopal_2014(gmusic_client, dry_run=False):
    ...
    repo = Gopal2014Repo(git_repo_paths=[os.path.join("/home/vvasuki/veda-audio/jaiminIya-sAma-paravastu", "jaiminIya-sAma-gAna-paravastu-tradition-gopAla-2014")], archive_audio_item=archive_audio_item, git_remote_origin_basepath="git@github.com:veda-audio", gmusic_client=gmusic_client)
