...
class RepoBase(audio_repo.BaseAudioRepo):
    def __init__(self, title, author, repo_paths,
...
def upload_volume(title, repo_paths, archive_id=None, author="ದೇವುಡು ನರಸಿಂಹ-ಶಾಸ್ತ್ರೀ devuDu-narasimha-shAstrI", dry_run=False, gmusic_client=None, description=None):
    repo = RepoBase(title=title, author=author, repo_paths=repo_paths, git_remote_origin_basepath="git@github.com:kannada-audio")
