...
class NormalizedFilesRepo(audio_repo.NormalizedRepo):
  metadata = {
    "title" : "shaivism-intro शैवाध्व-परिचयः",
    "description" : """
          shaivism-intro शैवाध्व-परिचयः। Foundational Shaivism and shiva sUtras by sthAneshvar timalsIna.  
  ...
  archive_id="sthAneshvara-shaivAdhva-parichayaH"


def update_repo(dry_run=False):
  repo = RepoBase(repo_paths=["/home/vvasuki/Music/git-curation/shAstra-audio/sthAneshvara-shaivism"])
